...
var _wiki_link_plugin = require("./wiki_link_plugin");
...
const gatherCandidates = term => ["1", "2", "3", "4", "5"];
...
const strategy = {
  ...
  context: beforeCursor => // Return false if the cursor is in code block or inline code notation
  ...
  search: async (term, callback, match //: RegExpMatchArray
  ) => {
