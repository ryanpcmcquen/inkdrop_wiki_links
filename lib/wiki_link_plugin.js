...
function wikiLinkPlugin(opts = {}) {
  ...
  let newClassName = opts.newClassName || "new"; // let wikiLinkClassName = opts.wikiLinkClassName || "internal wiki_link";

  let wikiLinkClassName = opts.wikiLinkClassName || "wiki_link"; // let defaultHrefTemplate = (permalink) => `#/page/${permalink}`;
